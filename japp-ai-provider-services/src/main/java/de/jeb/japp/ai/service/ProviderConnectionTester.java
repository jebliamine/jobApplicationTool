...
/**
 * Performs a minimal real call to a provider instance to verify its current
 * configuration actually works. Implemented in japp-generation-services
 * (which owns CoverLetterGenerationAdapterRegistry / the actual adapter
...
public interface ProviderConnectionTester {
    ...
    AiProviderTestResult test(UUID instanceId);
}
